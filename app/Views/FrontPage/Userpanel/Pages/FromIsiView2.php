...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/theme/davur/assets/vendor/sweetalert2@11.5.1/dist/sweetalert2.min.css'); ?>">
</head>
<body>
    ...
    <script src="<?php echo base_url('assets/theme/davur/assets/vendor/sweetalert2@11.5.1/dist/sweetalert2.all.min.js'); ?>"></script>
                ...
                Array.prototype.slice.call(forms).forEach(function (form) {
                    form.addEventListener('submit', function (event) {
                        if (!form.checkValidity()) {
                            ...
                            // Menampilkan SweetAlert saat form valid
                            Swal.fire({
                                position: "top-end",
                                icon: "success",
