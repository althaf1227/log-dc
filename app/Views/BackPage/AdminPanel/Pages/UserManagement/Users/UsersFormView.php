...
<?php } ?>
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="txt_nama" name="txt_nama" value="<?php if (is_null(old('txt_nama')) == false) { echo old('txt_nama'); } else { if (isset($operation) && isset($user_identity) && $operation == "edit") echo esc($user_identity->name); } ?>" placeholder="Masukan Nama.." required />
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="multi-select" id="slc_group" name="slc_group[]" multiple="multiple" required>
<?php
if (isset($datagroup)) {
    foreach ($datagroup as $row) {
?>
                                                    <option <?php if (isset($operation) && isset($user) && $operation == "edit") if (in_array($row, $user_group)) echo "selected"; ?>><?php echo esc($row); ?></option>
<?php
}}
?>
                                                </select>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="email" class="form-control" id="txt_email" name="txt_email" value="<?php if (is_null(old('txt_email')) == false) { echo old('txt_email'); } else { if (isset($operation) && isset($user_identity) && $operation == "edit") echo esc($user_identity->secret); } ?>" placeholder="Masukan Email.." required />
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="txt_username" name="txt_username" value="<?php if (is_null(old('txt_username')) == false) { echo old('txt_username'); } else { if (isset($operation) && isset($user) && $operation == "edit") echo esc($user->username); } ?>" placeholder="Masukan Username.." required />
...
<?php } ?>
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="multi-select slc_permission" id="slc_permission" name="slc_permission[]" multiple="multiple" required>
<?php
if (isset($datapermission)) {
    foreach ($datapermission as $row) {
?>
                                                    <option <?php if (isset($operation) && isset($user) && $operation == "edit") if (in_array($row, $user_permission)) echo "selected"; ?>><?php echo esc($row); ?></option>
<?php
}}
?>
                                                </select>
