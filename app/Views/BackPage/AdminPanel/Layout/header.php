                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-bs-toggle="dropdown">
									<div class="header-info">
										<span>Hello, <strong><?php echo esc(session('ses_account')['name']); ?></strong></span>
									</div>
                                    <img src="<?php echo base_url('uploads/logo/logo_kabupaten_pati.svg'); ?>" alt="">
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="<?php echo site_url('adminpanel/profile'); ?>" class="dropdown-item ai-icon">
                                    ...
                                    <a href="<?= url_to('logout') ?>" class="dropdown-item ai-icon">
